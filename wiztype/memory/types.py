...
class HashNode(MemoryObject):
    left: "HashNode" = ObjectPointer(0x0)
    parent: "HashNode" = ObjectPointer(0x8)
    right: "HashNode" = ObjectPointer(0x10)
    is_leaf: bool = Bool(0x19)
    hash: int = Signed4(0x20)
    node_data: "Type" = ObjectPointer(0x28, "Type")
...
class Type(MemoryObject):
    ...
    property_list: "PropertyList" = ObjectPointer(0x90, "PropertyList")
...
class PropertyList(MemoryObject):
    ...
    base_class_list: "PropertyList" = ObjectPointer(0x18)
    type: "Type" = ObjectPointer(0x20, "Type")
    pointer_version: "Type" = ObjectPointer(0x30, "Type")
...
class Property(MemoryObject):
    list: "PropertyList" = ObjectPointer(0x38, "PropertyList")
    container: "Container" = ObjectPointer(0x40, "Container")
    ...
    type: "Type" = ObjectPointer(0x70, "Type")
...
class Function(MemoryObject):
    list: "PropertyList" = ObjectPointer(0x30, "PropertyList")
    name: str = CppString(0x38)
    details: "FunctionDetails" = ObjectPointer(0x58, "FunctionDetails")
